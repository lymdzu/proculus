...
class TgPage{
    ...
    private function first(){
        return ' <li><a href="'.$this->url.'&page=1" aria-label="Previous"><span aria-hidden="true">Home</span></a></li>';
    }

    private function last(){
        return ' <li><a href="'.$this->url.'&page='.$this->pagenum.'" aria-label="Previous"><span aria-hidden="true">Last Page</span></a></li>';
    }
